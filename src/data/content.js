...
export const PAIN_POINTS = [
  ...
  new PainPoint({
    id: 4,
    icon: "M9 12l2 2 4-4M12 3a9 9 0 1 0 9 9",
    title: "QC ซ้ำซ้อน กินเวลาทีม",
    description:
      "เวลาส่วนใหญ่หมดไปกับการไล่ตรวจงานเดิม แทนที่จะได้ใช้กับงานที่สร้างมูลค่าให้ธุรกิจจริง ๆ",
  }),
];
...
export const SOLUTIONS = [
  ...
  new Solution({
    ...
    description:
      "วัดคุณภาพของข้อมูลที่ดึงออกมาแบบอัตโนมัติ พร้อมชี้จุดที่ควรให้คนตรวจซ้ำก่อน",
    solves: [pain(4)],
    benefit: "โฟกัส QC เฉพาะเอกสารที่มีความเสี่ยง",
  }),
];
